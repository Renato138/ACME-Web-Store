...
namespace Acme.Store.UI.Mvc.Controllers
{
    ...
    public class ProdutosController : MainController
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            //var pagRequest = new PaginationRequest(1, 20);
            //var pagResponse = await _produtoRepository.ObterPagina(pagRequest);
            //var pagination = new PaginationReponse<ProdutoExibirViewModel>(
            //    pagRequest,
            //    _mapper.Map<IEnumerable<ProdutoExibirViewModel>>(pagResponse.Items),
            //    pagResponse.TotalItems);
            //return View(pagination);
        }

        // GET: ProdutosController
        [Route("obter-pagina/{pageNum:int?}")]
        public async Task<ActionResult> ObterPagina(int? pageNum)
        {
            var pagRequest = new PaginationRequest( ! pageNum.HasValue || pageNum.Value < 1 ? 1 : pageNum.Value, 20);
